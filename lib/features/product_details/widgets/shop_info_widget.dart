    ...
    return Consumer<ShopController>(
      builder: (context, seller, child) {
        final bool isVacationActive = ShopHelper.isVacationActive(
          context,
          startDate: seller.sellerInfoModel?.seller?.shop?.vacationStartDate,
          endDate: seller.sellerInfoModel?.seller?.shop?.vacationEndDate,
          vacationDurationType:
              seller.sellerInfoModel?.seller?.shop?.vacationDurationType,
                          ...
                          Container(
                            ...
                            child: ClipRRect(
                              ...
                              child: CustomImageWidget(
                                  image: seller.sellerInfoModel?.seller != null
