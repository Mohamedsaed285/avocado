...
class _ReviewDialogState extends State<ReviewDialog> {
                            ...
                            Consumer<OrderDetailsController>(
                              ...
                              return CustomButton(
                                ...
                                onTap: () {
                                  if (reviewController.rating == 0) {
                                  ...
                                  } else if (isReviewUnchanged(
                                      reviewController)) {
                                    reviewController.setErrorText(
                                        '${getTranslated('modify_review_before_resubmitting', context)}');
                                  } else {
                                    reviewController.setErrorText('');
                                    ReviewBody reviewBody = ReviewBody(
                                        ...
                                        rating:
                                            reviewController.rating.toString(),
  ...
  bool isReviewUnchanged(ReviewController reviewController) {
    return reviewController.orderWiseReview?.rating ==
            reviewController.rating &&
        reviewController.orderWiseReview?.comment == _controller.text &&
        (reviewController.orderWiseReview?.attachmentFullUrl != null &&
            reviewController.reviewImages.isEmpty);
  }
}
