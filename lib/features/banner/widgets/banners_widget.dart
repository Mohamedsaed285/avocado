                                ...
                                SizedBox(
                                  ...
                                  child: CarouselSlider.builder(
                                    ...
                                    itemBuilder: (context, index, _) {
                                      // Skip the first item by adding 1 to the index
                                      int actualIndex = index + 1;

                                      return InkWell(
                                        onTap: () {
                                          if (bannerProvider
                                                  .mainBannerList![actualIndex]
                                                  .resourceId !=
                                              null) {
                                        ...
                                        child: ClipRRect(
                                          ...
                                          child: Container(
                                              ...
                                              child: CustomImageWidget(
                                                  image: '${bannerProvider.mainBannerList?[actualIndex].photoFullUrl?.path}')),
                                        ),
                                      );
                                    },
                                  ),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: bannerProvider.mainBannerList!
                            ...
                            int displayIndex = originalIndex - 1;
                            return displayIndex == bannerProvider.currentIndex
                                ? Container(
                                    ...
                                    child: Text(
                                      "${displayIndex + 1}/ ${bannerProvider.mainBannerList!.length - 1}",
