...
class AuthController with ChangeNotifier {
  ...
  // Test account login simulation
  Future<ResponseModel> testAccountLogin(
      String email, String password, FromPage? fromPage) async {
    _isLoading = true;
    _loginErrorMessage = '';
    notifyListeners();
    ...
    // Create mock response data similar to real login
    ...
    String token = mockResponseData["token"];
    String message = mockResponseData["message"];
    bool isPhoneVerified = mockResponseData["is_phone_verified"];
    bool isMailVerified = mockResponseData["is_email_verified"];
    ...
    return ResponseModel(message, true);
  }
}
